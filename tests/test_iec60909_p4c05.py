...
from mcp_electrico import core, iec60909, p4_completion, professional_data, visual_state
...
def test_p4c05_gate_done_but_p4_still_not_ready():
    ...
    for cid in ("P4C06", "P4C07", "P4C08", "P4C09", "P4C10", "P4C11", "P4C12"):
