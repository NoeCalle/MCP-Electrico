...
_MODULES = {
    ...
    "project_reconstruction": {
        ...
        "limitations": [
            ...
            "El reporte HTML/PDF reproducible todavía está pendiente",
    ...
    "professional_report": {
        ...
        "basis": None,
        "limitations": [
            "P7A ya implementa snapshot/hash y P7B reconstrucción de netlist, pero el reporte técnico reproducible HTML/PDF todavía está pendiente",
