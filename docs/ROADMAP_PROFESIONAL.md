...
| P11 — Release Safety | **ACTIVA — P11A/P11B DONE / P11C IN PROGRESS** | puntos de recuperación, contratos del core y mirror estable |
...
next_activity = P11C_RELEASE_EXPORT
...
**Estado: ACTIVA — P11A/P11B DONE / P11C IN PROGRESS.**
...
P11A registró el cierre P10G en `stable/0.9-reference-validated`. P11B congeló la superficie pública del primer uso controlado. P11C prepara un export portable exact-SHA, verificable por bundle y SHA-256, como paso previo al mirror independiente. Detalle: `docs/P11_RELEASE_SAFETY.md`.
