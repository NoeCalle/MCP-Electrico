...
- `P3C11` — cobertura primaria de 5A/5B/5C/5D/5E (**5B y 5D ya disponen de cobertura primaria completa y binding seguro hacia Iz; 5A/5C parciales y 5E pendiente**);
