...
| P10 — Reference Validation | **ACTIVA — P10A–P10F DONE / P10G IN PROGRESS** | proyecto de referencia independiente para validar la baseline congelada |
...
next_activity = P10G_REFERENCE_DOSSIER
