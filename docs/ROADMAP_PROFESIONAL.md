...
| P12 — Operating Scenarios | **ACTIVA — P12A–P12C DONE / P12D PENDING MERGE / P12E IN PROGRESS** | escenarios multiindustria, transferencia explícita y restauración determinista |
...
**Estado: ACTIVA — P12A–P12C DONE / P12D PENDING MERGE / P12E IN PROGRESS.**
...
P12C cerró ENABLE/DISABLE explícito de Load.* sin shedding automático. P12D expone el motor de escenarios mediante tools MCP públicas versionadas. P12E añade fuentes alternativas Thevenin y transferencia break-before-make explícita, sin selección automática de fuente ni transición cerrada. Después sigue comparación batch + Workspace/dossier; motores/arranque se desarrollarán como una fase transversal separada.
