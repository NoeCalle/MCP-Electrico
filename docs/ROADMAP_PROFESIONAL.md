...
| P10 — Reference Validation | **ACTIVA — P10A–P10E DONE / P10F IN PROGRESS** | proyecto de referencia independiente para validar la baseline congelada |
...
next_activity = P10F_REFERENCE_PROTECTION
